...
<p><spring:message code="administrator.create" /></p>
<form:form action="administrator/create.do" modelAttribute="admin">
	...
	<br/>
	<imput type="sumbit" name="save" value="<spring:message code="administrator.save" />"/>
</form:form>
