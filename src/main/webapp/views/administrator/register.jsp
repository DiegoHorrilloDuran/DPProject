...
<p><spring:message code="administrator.register" /></p>
<form:form action="administrator/register.do" modelAttribute="admin">
	...
	<br/>
	<input type="sumbit" name="save" value="<spring:message code="admin.save" />"/>
</form:form>
